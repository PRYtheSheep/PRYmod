...
public class PRYBlockScreen extends AbstractContainerScreen<PRYBlockContainer> {
    ...
    private final ResourceLocation GUI = new ResourceLocation(PRYmod.MODID, "textures/gui/pryblockgui.png");

    public PRYBlockScreen(PRYBlockContainer container, Inventory inventory, Component title) {
